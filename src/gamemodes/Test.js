...
module.exports = Test;
Test.prototype = new Mode;

Test.prototype.leaderboardAddSort = function (player, leaderboard) {
...
Test.prototype.onPlayerSpawn = function (gameServer, player) {
    player.setColor(player.isMinion ? { r: 240, g: 240, b: 255 } : gameServer.getRandomColor());
    // Spawn player
    gameServer.spawnPlayer(player);
};

Test.prototype.updateLB = function (gameServer) {
